    ...
    return (
      <div className="container ">
        <div className="register-form">
          <div className="title mx-auto">REGISTER USERS</div>
          <div className="form mb-7 mx-auto ">
            <div>
              <label>
                First Name
                <input
            ...
            <div>
              ...
              <span
                className="required-field"
                style={this.requiredStyle("lastName")}
              >
            ...
            <div>
              ...
              <span
                className="required-field"
                style={this.requiredStyle("username")}
              >
            ...
            <div>
              ...
              <span className="note" style={helpMessage("password")}>
                At least 8 characters
              </span>
              <span
                className="required-field"
                style={this.requiredStyle("password")}
              >
            ...
            <div>
              ...
              <span className="note" style={helpMessage("email")}>
                An activatoin link will be sent to this email
              </span>
              <span
                className="required-field"
